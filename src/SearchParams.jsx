...
const SearchParams = () => {
  ...
  const [adoptedPet] = useContext(AdoptedPetContext); // Just ignoring the setter part of the hook (destructing the first element)
  ...
  return (
    <div className="search-params">
      ...
      >
        {
          adoptedPet? (
            <div className="pet iamge-container">
